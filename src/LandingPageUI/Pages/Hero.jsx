    ...
    return (
        <div style={{
          ...
          <div className="z-10 w-full lg:w-10/12 xl:max-w-7xl mx-auto ">
            ...
            <button className="border px-4 sm:px-6 py-2 sm:py-2.5 bg-white/5 rounded-full text-white shadow-none backdrop-blur-xs text-xs sm:text-xs">{t('hero.tagline')}</button>
