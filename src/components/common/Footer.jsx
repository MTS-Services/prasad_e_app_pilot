      ...
      <div className="bg-gray-50 py-16 px-4 sm:px-6 md:px-8 lg:px-10">
        <div className="lg:w-10/12 mx-auto max-w-7xl">
          <div className="bg-green-900 relative -mb-42 z-40 rounded-2xl p-8 md:p-12 text-center shadow-lg">
            ...
            <button className="btn btn-sm md:btn-md lg:btn-lg bg-green-500 hover:bg-gray-100 hover:text-green-500 text-white font-medium border-transparent px-8 py-3 rounded-sm transition-colors shadow-md">
              {t("footer.cta.button")}
            </button>
          </div>
        </div>
